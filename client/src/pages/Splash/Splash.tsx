...
const numberOfThumbnailsCreated = (await getImageCount() + 600) || '1000'
                ...
                <Grid item sm={12} md={7} sx={{margin: '0 auto'}}>
                    <Container sx={{width: '100%'}}>
                        <Typography sx={{"fontSize": '25px'}}>
                            Over <span style={{"color": '#f5d762', "fontWeight": '800'}}>{numberOfThumbnailsCreated} Thumbnails</span> Created!
                        </Typography>
                        <GalleryGrid />
                    </Container>
                </Grid>
